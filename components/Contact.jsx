            ...
            <div className="lg:p-4 h-full">
              <div>
                <img
                  ...
                  src="https://images.unsplash.com/photo-1536300099515-6c61b290b654?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                  alt="/"
                />
              </div>
              <div>
                ...
                <p className="py-4">
                  I am available for freelance or fulltime position. Contact me
                  and let's talk.
                </p>
              </div>
              <div>
        ...
        <div className="flex justify-center py-12">
          <Link href="/">
            <div className="rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer hover:scale-110 ease-in duration-150">
              <FaAngleDoubleUp className="m-auto text-[#5651e5]" size={30} />
            </div>
          </Link>
        </div>
      </div>
